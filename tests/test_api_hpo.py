...
def test_hpo_endpoint_forwards_parallel_worker_count(monkeypatch, workspace_tmp_path):
    ...
    monkeypatch.setattr("backend.api.main.validate_train_dataset_name", lambda dataset_name: None)

    import scripts.hpo_search as hpo_search

    captured = {}

    def fake_run_hpo(n_trials: int, n_jobs: int, experiment_name: str, dataset_name: str | None = None, **kwargs):
        ...
        return {
            ...
            "dataset_kind": "tabular" if dataset_name else "mnist",
        }
